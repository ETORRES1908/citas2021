    ...
    <div class="card-body">
        <div class="container py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" style="padding:10px 50px 0px 75px">
                ...
                <article class="w-full h-80 bg-cover bg-center bg-lightblue-400"
                    style="background-color:{{$speciality->color}};border-radius:15px;">
                    ...
                    {{-- @if($speciality->nombre=='Medicina General') --}}
                        md:col-span-1
                        @endif"
                                style="background-image: url('../images/especialistas/medicina1.jpg'); border-radius: 15px">

                                <div class="w-full h-full px-8 flex flex-col justify-center"
                                    style="padding: 100px 10px 10px 10px">
                                    <div>
                                        <a href="#"
                                            class="inline-block px-3 h-6 bg-lightblue-600 text-gray rounded-full"></a>
                                    </div>
                                    <h1 class="text-2xl text-black leading-0 font-bold">
                    ...
                    {{-- @if($speciality->nombre=='Medicina General') --}}
                        md:col-span-1
                        @endif"
                                style="background-image: url('../images/especialistas/odontologia.jpg'); border-radius: 15px">
                    ...
                    {{-- @if($speciality->nombre=='Medicina General') --}}
                        md:col-span-1
                        @endif"
                                style="background-image: url('../images/especialistas/obstetricia1.jpg'); border-radius: 15px">
                    ...
                    {{-- @if($speciality->nombre=='Medicina General') --}}
                        md:col-span-1
                        @endif"
                                style="background-image: url('../images/especialistas/pediatria.jpg'); border-radius: 15px">

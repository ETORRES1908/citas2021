            ...
            <div class="card-body">
                ...
                <div class="form-group ">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('nombre', $user->profile->nombre, ['class' => 'form-control','disabled']) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('apellido', 'Apellidos') !!}
                        {!! Form::text('apellido', $user->profile->apellido, ['class' => 'form-control', 'disabled'])
                        !!}
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('sexo',array('m'=>'Masculino','f'=>'Femenino'), $user->profile->sexo, ['class'
